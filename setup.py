...
class build_ext(_build_ext):
    def finalize_options(self):
        ...
        sources = [ 'src/tides_spin.c', 'src/integrator_euler.c', 'src/exponential_migration.c', 'src/integrator_rk4.c', 'src/gravitational_harmonics.c', 'src/integrator_rk2.c', 'src/linkedlist.c', 'src/type_I_migration.c', 'src/interpolation.c', 'src/track_min_distance.c', 'src/stellar_evolution_sse.c', 'src/radiation_forces.c', 'src/stochastic_forces.c', 'src/output.c', 'src/core.c', 'src/modify_orbits_direct.c', 'src/modify_orbits_forces.c', 'src/stellar_wind_mass_loss.c', 'src/thermally_driven_winds.c', 'src/eddington_winds.c', 'src/integrate_force.c', 'src/modify_mass.c', 'src/integrator_implicit_midpoint.c', 'src/rebxtools.c', 'src/steppers.c', 'src/gr_full.c', 'src/input.c', 'src/gas_damping_timescale.c', 'src/inner_disk_edge.c', 'src/gr_potential.c', 'src/yarkovsky_effect.c', 'src/gas_dynamical_friction.c', 'src/lense_thirring.c', 'src/roche_lobe_mass_transfer.c', 'src/tides_constant_time_lag.c', 'src/gr.c', 'src/central_force.c', 'src/magnetic_braking.c', 'src/post_newtonian.c'],
