...
class build_ext(_build_ext):
    def finalize_options(self):
        ...
        sources = [ 'src/central_force.c', 'src/core.c', 'src/eddington_winds.c', 'src/exponential_migration.c', 'src/gas_damping_timescale.c', 'src/gas_dynamical_friction.c', 'src/gr.c', 'src/gravitational_harmonics.c', 'src/gr_full.c', 'src/gr_potential.c', 'src/inner_disk_edge.c', 'src/input.c', 'src/integrate_force.c', 'src/integrator_euler.c', 'src/integrator_implicit_midpoint.c', 'src/integrator_rk2.c', 'src/integrator_rk4.c', 'src/interpolation.c', 'src/lense_thirring.c', 'src/linkedlist.c', 'src/magnetic_braking.c', 'src/modify_mass.c', 'src/modify_orbits_direct.c', 'src/modify_orbits_forces.c', 'src/output.c', 'src/post_newtonian.c', 'src/radiation_forces.c', 'src/rebxtools.c', 'src/roche_lobe_mass_transfer.c', 'src/stellar_evolution_sse.c', 'src/stellar_wind_mass_loss.c', 'src/steppers.c', 'src/stochastic_forces.c', 'src/thermally_driven_winds.c', 'src/tides_constant_time_lag.c', 'src/tides_spin.c', 'src/track_min_distance.c', 'src/type_I_migration.c', 'src/yarkovsky_effect.c'],
